...
def register_operator_svc(name,user,password,direct_manager,id_enterprise,type_acess,shift_work):
    ...
    register_operator_db(name, user, password, direct_manager,id_enterprise,type_acess,shift_work)
